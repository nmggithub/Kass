...
extension Mach {
    ...
    public struct VirtualMemoryManager {
        ...
        internal static func unsafeRawPointerToMachVMAddress(_ pointer: UnsafeRawPointer?) throws
            -> mach_vm_address_t
        {
        ...
        internal static func machVMAddressToUnsafeRawPointer(_ address: mach_vm_address_t) throws
            -> UnsafeRawPointer?
        {
...
extension Mach {
    ...
    public struct VMInherit: KassHelpers.NamedOptionEnum {
        ...
        public static var donateCopy: Self { Self(name: "don", rawValue: VM_INHERIT_DONATE_COPY) }
    }
...
extension Mach.VirtualMemoryManager {
    ...
    public func read<T: BitwiseCopyable>(from inPointer: UnsafeRawPointer?) throws -> T {
...
extension Mach {
    ...
    public struct VMSyncFlags: OptionSet, KassHelpers.NamedOptionEnum {
        ...
        public static let asynchronous = Self(name: "asynchronous", rawValue: VM_SYNC_ASYNCHRONOUS)
...
extension Mach {
    ...
    public struct VMBehavior: KassHelpers.NamedOptionEnum {
        ...
        public static let willNeed = VMBehavior(name: "willNeed", rawValue: VM_BEHAVIOR_WILLNEED)

        public static let dontNeed = VMBehavior(name: "dontNeed", rawValue: VM_BEHAVIOR_DONTNEED)
        ...
        public static let reusable = VMBehavior(name: "reusable", rawValue: VM_BEHAVIOR_REUSABLE)

        public static let reuse = VMBehavior(name: "reuse", rawValue: VM_BEHAVIOR_REUSE)

        public static let canReuse = VMBehavior(name: "canReuse", rawValue: VM_BEHAVIOR_CAN_REUSE)
...
extension Mach {
    ...
    public struct VMPurgeable: KassHelpers.NamedOptionEnum {
        ...
        public static let setState = VMPurgeable(name: "setState", rawValue: VM_PURGABLE_SET_STATE)

        public static let purgeAll = VMPurgeable(name: "purgeAll", rawValue: VM_PURGABLE_PURGE_ALL)
    }
    ...
    public struct VMPurgeableOrdering: KassHelpers.NamedOptionEnum {
        ...
        public static let obsolete = Self(name: "obsolete", rawValue: VM_PURGABLE_ORDERING_OBSOLETE)
    ...
    public struct VMPurgeableBaseState: KassHelpers.NamedOptionEnum {
        ...
        public static let nonVolatile = Self(name: "nonVolatile", rawValue: VM_PURGABLE_NONVOLATILE)
