    ...
    extension OS {
        ...
        public class IOKitMainPort: MachCore.Mach.Port {
            ...
            public convenience init(withBootstrapPort bootstrapPort: MachCore.Mach.BootstrapPort)
                throws
            {
        ...
        public class IOService: IOObject {
            ...
            public struct IOServiceAuthorizeOptions: OptionSet, Sendable,
        ...
        public class IOConnect: IOObject {
            ...
            public func callMethod(
                ...
                let outputScalarsPointer: UnsafeMutablePointer<UInt64>? =
                    ...
                    ? UnsafeMutablePointer<UInt64>.allocate(
                        capacity: Int(expectedOutputScalarsCount))
                    : nil
                let outputStructurePointer: UnsafeMutableRawPointer? =
                    ...
                    : expectedOutputStructureSize == kIOConnectMethodVarOutputSize
                        ? UnsafeMutableRawPointer(
                            UnsafeMutablePointer<UnsafeRawPointer>.allocate(capacity: 1)
                        )
                        : nil
                try Mach.call(
                    IOConnectCallMethod(
