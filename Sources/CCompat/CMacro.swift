...
/// - Remark: This protocol is meant to be used with raw-value enums that represent C macros
...
/// - Remark: This protocol is meant to be used with raw-value enums that represent C option macros
