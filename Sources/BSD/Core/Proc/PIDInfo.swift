    ...
    extension BSD {
        ...
        public struct Proc {
            ...
            public func threadPathInfo(tsdAddress: UnsafeRawPointer) throws
            ...
            public var vmRealtimeFaultRecords: [vm_rtfault_record_t] {
                get throws {  // The largest buffer size is `Int32.max`, so the maximum count is that
                    ...
                    return try self.info(
                        flavor: .vmRealtimeFaultInfo, count: maxDynamicQueuesPerProc)
                }
            }
                ...
                get throws {
                    ...
                    let dataSize =
                        ...
                        + (Int(numberOfPerformanceLevels)
                            * MemoryLayout<proc_threadcounts_data>.size)
