 ...
 *
 * Original: https://github.com/apple-oss-distributions/xnu/blob/xnu-11215.41.3/bsd/sys/codesign.h
 * Only the `csops`-related definitions from the original file are included here.
 *
