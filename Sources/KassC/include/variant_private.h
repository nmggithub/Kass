 ...
 *
 * Original: https://github.com/apple-oss-distributions/Libc/blob/Libc-1669.0.4/os/variant_private.h
 * No modifications have been made from the original source code except for this line, the preceding one, and
 *  the removal of bridgeOS from the availability tags (to avoid compiler issues).
 *
