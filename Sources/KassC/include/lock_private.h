...
typedef OS_LOCK_STRUCT(base){
  protected : constexpr OS_LOCK(base)(){}
} * os_lock_t;
...
#define OS_LOCK_INIT(type)                                                     \
  {                                                                            \
      .osl_type = &OS_LOCK_TYPE_REF(type),                                     \
  }
...
__WATCHOS_AVAILABLE(3.0) OS_EXPORT OS_LOCK_TYPE_DECL(unfair);
...
__IOS_AVAILABLE(10.0)
__TVOS_AVAILABLE(10.0)
__WATCHOS_AVAILABLE(3.0) OS_EXPORT OS_LOCK_TYPE_DECL(nospin);
 ...
 */
__OSX_AVAILABLE_STARTING(__MAC_10_9, __IPHONE_7_0)
OS_EXPORT OS_NOTHROW OS_NONNULL_ALL void os_lock_lock(os_lock_t lock);
 ...
 */
__OSX_AVAILABLE_STARTING(__MAC_10_9, __IPHONE_7_0)
OS_EXPORT OS_NOTHROW OS_NONNULL_ALL bool os_lock_trylock(os_lock_t lock);
 ...
 */
__OSX_AVAILABLE_STARTING(__MAC_10_9, __IPHONE_7_0)
OS_EXPORT OS_NOTHROW OS_NONNULL_ALL void os_lock_unlock(os_lock_t lock);
...
OS_OPTIONS(os_unfair_lock_options, uint32_t,
           ...
           OS_UNFAIR_LOCK_DATA_SYNCHRONIZATION OS_SWIFT_NAME(
               DataSynchronization) OS_UNFAIR_LOCK_AVAILABILITY = 0x00010000,
           OS_UNFAIR_LOCK_ADAPTIVE_SPIN OS_SWIFT_NAME(AdaptiveSpin)
               __API_AVAILABLE(macos(10.15), ios(13.0), tvos(13.0),
                               watchos(6.0)) = 0x00040000,
           OS_UNFAIR_LOCK_DEADLINE OS_SWIFT_NAME(Deadline)
               __API_AVAILABLE(macos(14.3), ios(17.4), watchos(10.4),
                               tvos(17.4)) = 0x02000000, );

#if __swift__
#define OS_UNFAIR_LOCK_OPTIONS_COMPAT_FOR_SWIFT(name)                          \
  static const os_unfair_lock_options_t name##_FOR_SWIFT OS_SWIFT_NAME(name) = \
      name
...
OS_EXPORT OS_NOTHROW OS_NONNULL_ALL void
...
OS_EXPORT OS_NOTHROW OS_NONNULL_ALL bool os_unfair_lock_trylock_with_options(
    os_unfair_lock_t lock, os_unfair_lock_options_t options, uint64_t duration);
...
__API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0))
OS_EXPORT OS_NOTHROW OS_NONNULL_ALL void
os_unfair_lock_unlock_no_tsd(os_unfair_lock_t lock, mach_port_t mts);
...
#define OS_UNFAIR_RECURSIVE_LOCK_AVAILABILITY                                  \
  ...
  __IOS_AVAILABLE(12.0) __TVOS_AVAILABLE(12.0) __WATCHOS_AVAILABLE(5.0)
...
#define OS_UNFAIR_RECURSIVE_LOCK_INIT                                          \
  (os_unfair_recursive_lock((os_unfair_recursive_lock){OS_UNFAIR_LOCK_INIT, 0}))
#else
 ...
 */
OS_UNFAIR_RECURSIVE_LOCK_AVAILABILITY
OS_INLINE OS_ALWAYS_INLINE OS_NOTHROW OS_NONNULL_ALL void
 ...
 */
OS_UNFAIR_RECURSIVE_LOCK_AVAILABILITY
OS_EXPORT OS_NOTHROW OS_WARN_RESULT OS_NONNULL_ALL bool
 ...
 */
OS_UNFAIR_RECURSIVE_LOCK_AVAILABILITY
OS_EXPORT OS_NOTHROW OS_NONNULL_ALL bool
...
OS_UNFAIR_RECURSIVE_LOCK_AVAILABILITY
OS_INLINE OS_ALWAYS_INLINE OS_NOTHROW OS_NONNULL_ALL void
os_unfair_recursive_lock_assert_not_owner(
    const os_unfair_recursive_lock *lock) {
 ...
 */
__OSX_AVAILABLE(10.15)
__IOS_AVAILABLE(13.0)
__TVOS_AVAILABLE(13.0)
...
#define os_unfair_lock_lock_scoped_guard(guard_name, lock)                     \
  os_unfair_lock_t __attribute__((                                             \
      cleanup(os_unfair_lock_scoped_guard_unlock))) guard_name = lock;         \
 ...
 */
__API_AVAILABLE(macos(10.16), ios(14.0), tvos(14.0), watchos(7.0))
OS_INLINE OS_ALWAYS_INLINE OS_NONNULL_ALL void
...
os_unfair_lock_unlock_no_tsd_inline(os_unfair_lock_t lock, mach_port_t mts) {
  ...
  if (!OSLOCK_STD(atomic_compare_exchange_strong_explicit)(
          ...
          OSLOCK_STD(memory_order_release), OSLOCK_STD(memory_order_relaxed))) {
 ...
 */
OS_UNFAIR_LOCK_AVAILABILITY
OS_INLINE OS_ALWAYS_INLINE OS_WARN_RESULT OS_NONNULL_ALL bool
