...
#define TASK_SUPPRESSION_POLICY_COUNT ((mach_msg_type_number_t)(sizeof(struct task_suppression_policy) / sizeof(integer_t)))
...
#define TASK_POLICY_STATE_COUNT ((mach_msg_type_number_t)(sizeof(struct task_policy_state) / sizeof(integer_t)))
