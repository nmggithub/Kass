 ...
 *
 * Original: https://github.com/apple-oss-distributions/xnu/blob/xnu-11215.41.3/bsd/sys/proc_info.h
 * No modifications have made from the original source code except for this line, the preceding one,
 * and some formatting differences, and the additional definitions of the syscall wrappers.
 *
...
// Syscall wrapper definitions (taken from a not-directly-related `proc_info.c` in the XNU kernel source code).
