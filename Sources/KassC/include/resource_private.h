 ...
 *
 * Original: https://github.com/apple-oss-distributions/xnu/blob/xnu-11215.81.4/bsd/sys/resource_private.h
 * No modifications have been made from the original source code except for this line, the preceding one, some
 *  formatting differences, and the removal of the include statement for "AvailabilityInternalPrivate.h".
 *
